...
class Sequence_050 : public Sequence {
  ...
  public: 
    void populate() {
        ...
        tick12.channel[0].duration = POOF_SIZE_LARGE;
        tick12.channel[1].priority = 1;
        tick12.channel[1].duration = POOF_SIZE_LARGE;
        ...
        tick36.channel[1].duration = POOF_SIZE_LARGE;
        ...
        tick60.channel[1].duration = POOF_SIZE_LARGE;
        ...
        tick84.channel[1].duration = POOF_SIZE_LARGE;
